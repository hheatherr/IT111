public class MyVariable1 {
    ...
    public static void main(String [] args) {
        String name = "Heather"; // after a statement, don't forget the semicolon!
        int hours = 40; // we are assigning 40 to the hours variable.
        // Please note when we have a string value, it's nested in ""
        //when we are referring to numbers/integers, no quotes! Heather is a string so it has quotes.
